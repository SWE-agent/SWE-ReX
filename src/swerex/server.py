...
class ResponseManager:
    ...
    Note that because this relies on an idempotency key generated by the client, in the
    case of multiple clients making the same request, it will still execute the request
    multiple times because different idempotency keys will be generated.
    """
